...
namespace ManagedWinapi {
    ...
    public class LockKeyResetter : IDisposable {
        private static readonly Keys[] MODIFIER_KEYS = {
            Keys.RShiftKey, Keys.LShiftKey, Keys.ShiftKey, Keys.RMenu, Keys.LMenu, Keys.Menu, Keys.RControlKey,
            Keys.LControlKey, Keys.LMenu, Keys.RWin, Keys.LWin, Keys.CapsLock
        };
